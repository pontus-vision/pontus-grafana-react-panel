...
export interface PVEditGridFormEditorProps extends PVGridColSelectorProps {
  templateText?: string;
}

export interface PVEditGridFormEditorState extends PVEditGridFormEditorProps {
  height?: number;
  width?: number;
...
class PVEditGridFormEditor extends PontusComponent<
  PanelOptionsEditorProps<PVEditGridFormEditorProps | string>,
  PVEditGridFormEditorState
> {
  // private val: string;
  private od: any;

  constructor(props: Readonly<PanelOptionsEditorProps<PVEditGridFormEditorProps | string>>) {
    super(props);
...
export default PVEditGridFormEditor;
