...
var PVGremlinComboBox = /** @class */ (function (_super) {
    ...
    function PVGremlinComboBox(props) {
        ...
        _this.state = __assign(__assign({}, props), { value: lastVal, 
    ...
    PVGremlinComboBox.prototype.render = function () {
        ...
        return (React.createElement(Creatable, { name: this.props.name || 'form-field-name', 
            // key={this.state.value}
            defaultValue: this.state.value, isMulti: this.props.multi === null ? true : this.props.multi, isClearable: true, options: this.state.options, joinValues: true, delimiter: ',', onChange: this.onChange, placeholder: this.state.placeholder, styles: customStyles }));
        /*       return (
