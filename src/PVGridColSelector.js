...
var PVGridColSelector = /** @class */ (function (_super) {
    ...
    PVGridColSelector.prototype.render = function () {
        ...
        //   </View>
        // </View>);
        return (React.createElement("div", { style: { width: '100%', height: '100%', flexDirection: 'column', display: 'flex' } },
            React.createElement("div", { style: { display: 'block', width: '100%', padding: '10px' } },
                React.createElement(PVGremlinComboBox, { namespace: this.namespace + "-node-types", name: "node-types", multi: false, onChange: this.onChangeVertexLabels, onError: this.onError, url: PontusComponent.getRestVertexLabelsURL(this.props), placeholder: PontusComponent.t('Data Type'), 
                    // style={{width: "100%"}}
                    value: nodeTypesVal })),
            React.createElement("div", { style: { display: 'block', width: '100%', padding: '10px' } },
                React.createElement(PVGremlinComboBox, { name: "node-property-types", namespace: this.namespace + "-node-property-types", multi: true, onChange: this.onChangeNodePropertyNames, onError: this.onError, ref: this.setObjNodePropertyNames, url: PontusComponent.getRestNodePropertyNamesURL(this.props), placeholder: PontusComponent.t('Columns'), optionsRequest: nodeTypesReq, value: propTypesVal }))));
    };
